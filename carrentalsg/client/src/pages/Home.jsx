  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        ...
        // Assuming the API returns an array of listings directly
    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          SG Car rental is the best place to find your next rental for cars.
          <br />
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              <h2 className='text-2xl font-semibold text-slate-600'>Recent cars for rent</h2>
              <Link className='text-sm text-blue-800 hover:underline' to={'/search?type=sale'}>Show more cars for rent</Link>
            </div>
            <div className='flex flex-wrap gap-4'>
